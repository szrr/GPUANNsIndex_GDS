...
public:
	...
	virtual void SearchTopKonDevice(float* queries, int num_of_topk, int* &results, int num_of_query_points, int num_of_candidates,vector<std::vector<int>> enterPoints,Timer* &graphSearch) = 0;
