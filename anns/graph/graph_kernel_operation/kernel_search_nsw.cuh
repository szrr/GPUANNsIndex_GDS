...
void SearchDevice(float* d_data, float* d_query, int* d_result, int* d_graph, int total_num_of_points, int num_of_query_points, int offset_shift, 
                    ...
                    int* d_enter_cluster, int** d_rvq_indices, int* d_rvq_indices_size, int shared_mem_size, int* d_count, int* d_zero_count) {
...
//Search    
    ...
    int zero_flag = 0;
    if(enter_points_num > 500) enter_points_num = 500;
