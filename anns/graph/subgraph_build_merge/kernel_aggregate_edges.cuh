...
__global__ 
void AggragateEdges (KernelPair<float, int>* d_main_graph, KernelPair<float, int>* neighbors, Edge* edge_list, int* flags, int total_num_of_points, int num_of_visited_points_one_batch, int offset_shift) {
