...
int main(int argc,char** argv){
    ...
    int* results = NULL;
    cout << "Search...Query number: " <<query_points->GetNumPoints()<<endl << endl;
    graph->SearchTopKonDevice(query_points->GetFirstPositionofPoint(0), num_of_topk, results, query_points->GetNumPoints(), num_of_candidates, groundtruth);
